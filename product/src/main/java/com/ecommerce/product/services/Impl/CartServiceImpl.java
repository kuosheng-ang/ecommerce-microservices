...
import com.ecommerce.product.models.CartItem;
...
//import com.ecommerce.product.util.AuthUtil;
   ...
   /* @Override
    ...
    public CartDTO getCart(String emailId, Long cartId) {
        ...
        cart.getCartItems().forEach(c ->
                c.getProduct().setStockQuantity(c.getQuantity()));
    ...
    public CartDTO updateProductQuantityInCart(Long productId, Integer quantity) {
        ...
        String emailId = "kuosheng.ang@gmail.com";
    ...
    public String createOrUpdateCartWithItems(List<CartItemDTO> cartItems) {
        ...
        for (CartItemDTO cartItemDTO : cartItems) {
            ...
            Integer quantity = cartItemDTO.getCartQuantity();
